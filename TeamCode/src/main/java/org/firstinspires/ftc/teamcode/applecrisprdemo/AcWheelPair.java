 ...
 */
public class AcWheelPair {
    private String LeftMotorName;
    private String RightMotorName;
    private String ControllerName;

    private AcOldMotor wheelOne; // Formerly wheelLeft
    private AcOldMotor wheelTwo; // Formerly wheelRight

    private int leftPower = 0;
    private int rightPower = 0;

    private AcOldMotorController control;
    ...
    public AcWheelPair(String motor1Name, String motor2Name, String controllerName) {
        wheelOne = new AcOldMotor(motor1Name);
        wheelTwo = new AcOldMotor(motor2Name);
        control = new AcOldMotorController(controllerName);
    }
